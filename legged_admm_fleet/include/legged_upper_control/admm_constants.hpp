...
inline constexpr double D_MIN = 1.3;  // Vision60 URDF FK (2026-07-23): the LEGS reach past the
                                      // base box — hind knee (calf frame) 0.609m, trot swing foot
                                      // 0.542m, vs base-box corner only 0.433. 2*0.609=1.22 =
                                      // knee-knee contact; D_MIN=1.3 = +0.08 margin. Was 1.0
                                      // (base-box-only 2*0.433+0.13, which UNDER-counted legs).
                                      // (a point-mass value < body length -> physical overlap).
