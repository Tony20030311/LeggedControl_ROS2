...
# C6h: Python retired — this gate runs against the C++ port via the shim.
...
def test_admm_edge_constants():
    ...
    assert abs(C.D_MIN - 1.3) < 1e-9          # inter-agent min separation [m] (Vision60 URDF FK: 2*hind-knee 0.609 + margin)
