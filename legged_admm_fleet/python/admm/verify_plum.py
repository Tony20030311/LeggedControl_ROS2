...
W_FORM = 10.0
TOL = 1e-6
# Aligned to legacy reactive QP (same as verify_door): peg radius 0.30 + robot_radius
# 0.20 = 0.50 A* inflation == node-CBF r_eff (0.30 + ROBOT_MARGIN 0.20 = 0.50) -> the
# reference centre rides the bubble edge; Gazebo-proven (15-round + fuzz campaigns).
ROBOT_MARGIN = 0.20
