...
must be pointed at it (see g_arena_run.sh, TODO next session).
...
ARENAS = {
    "empty": {"circles": [], "rects": []},  # ground+sun only; lets legged_admm_fleet be the single gazebo_package
    "plum": {
        # Positions match fleet_config.cpp plum (A1 coords upscaled 1.4x for Vision60).
